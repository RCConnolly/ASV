/* Runs FM2 algorithm on island image with borders. */
...
int main(int argc, const char ** argv)
{
    ...
    //s->setInitialAndGoalPoints({3800, 6600}, {7125, 3600}); // full channels
    //s->setInitialAndGoalPoints({370, 650}, {610, 534}); // channels 10% size
    //s->setInitialAndGoalPoints({225, 350}, {730, 220}); // island
    //s->setInitialAndGoalPoints({950, 1640}, {1550, 1330}); // channels 25% size
    s->setInitialAndGoalPoints({200, 620}, {700, 688}); // channels 25% size
    std::cout << "initial and goal set\n";
    s->compute();
